...
# ## Adapted from joint sentences used in ENTITY DETECTOR BY BERT
# 
# AT 14 jun 2025
...
nome_lista = f'{pipeline}/{dataset}_PROCESSED/test_files_list.csv'  # CHANGET TO test files
...
output_file = os.path.join(output_dir, "concatenated_test_sentences_v2.csv")
