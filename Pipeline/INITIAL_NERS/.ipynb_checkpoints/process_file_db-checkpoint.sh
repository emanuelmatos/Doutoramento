...
# Directories
SOURCE_DIR="/Users/easm/phd/NER/INPUT_DATASET/"
DEST_DIR="/Users/easm/phd/NER/OUTPUT_RESULTS/"
CSV_FILE="process.csv"
PROCESSED_LIST="list_processed.csv"

# Create or clear the processed list CSV file
if [[ ! -f "$PROCESSED_LIST" ]]; then
  echo "Filename,BaseName" > "$PROCESSED_LIST"
else
...
for line in "${lines[@]}"; do
  ...
  echo "Processing file: $filename with basename: $name ..........................................................................."
  ...
  python process_phase_db.py "$name"
